\begin{tikzpicture}
    ...
    \draw[dashed,blue] (2,2,1) circle(1pt);
    ...
    % 10
    \draw[blue] (2,0,1)  -- (2,2,1);
    \draw[blue] (2,0,1)  -- (2,1,0);
    % 12
    \draw[dashed,blue] (0,1,0)  -- (2,1,0);
    \draw[dashed,blue] (0,1,0)  -- (0,2,2);
    \draw[dashed,blue] (0,1,0)  -- (0,0,1);
    % 15
    \draw[blue] (2,1,0)  -- (2,2,1);
    % 18
    \draw[blue] (2,2,1)  -- (0,2,0);
