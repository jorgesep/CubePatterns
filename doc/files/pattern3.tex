\begin{tikzpicture} %pattern3
	...
	\draw[cube] (2,2,0) -- (2,2,2);
        ...
        \draw node at (1,2.1,2.1) {\tiny 17};
        \draw[blue] (1,0,0) circle(1pt);
        \draw[blue] (1,2,2) circle(1pt);

        \draw[dashed,blue] (1,0,0)  -- (0,0,2);
        \draw[dashed,blue] (1,0,0)  -- (2,0,2);
        \draw[dashed,blue] (1,0,0)  -- (0,2,0);
        \draw[dashed,blue] (1,0,0)  -- (2,2,0);
        \draw[blue] (1,2,2)  -- (0,2,0);
        \draw[blue] (1,2,2)  -- (2,2,0);
        \draw[blue] (1,2,2)  -- (0,0,2);
        \draw[blue] (1,2,2)  -- (2,0,2);
