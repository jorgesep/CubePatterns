\begin{tikzpicture}
    ...
    \draw node at (-0.1,0.1,1) {\tiny 8};
    \draw node at (1,0,2.1)    {\tiny 9};
    \draw node at (2.1,0.1,1)  {\tiny 10};
    \draw node at (1,0.1,-0.1) {\tiny 11};
    \draw node at (-0.1,1,0)   {\tiny 12};
    \draw node at (-0.1,1,2)   {\tiny 13};
    \draw node at (2.1,1,0)    {\tiny 15};
    \draw node at (1,2.1,-0.1) {\tiny 19};
    \draw node at (1,1.1,1)    {\tiny 20};
    \draw node at (-0.1,1.1,1) {\tiny 21};
    \draw node at (1,1.1,0)    {\tiny 24};
    \draw[dashed,blue] (0,0,1) circle(1pt);
    \draw[dashed,blue] (1,0,2) circle(1pt);
    \draw[dashed,blue] (2,0,1) circle(1pt);
    ...
    \draw[dashed,blue] (1,0,1) circle(1pt);
    \draw[dashed,blue] (0,1,1) circle(1pt);
    \draw[dashed,blue] (1,1,0) circle(1pt);

    % 8
    \draw[dashed,blue] (0,0,1)  -- (0,1,0);
    \draw[dashed,blue] (0,0,1)  -- (0,2,2);
    \draw[dashed,blue] (0,0,1)  -- (2,0,1);
    %9
    \draw[dashed,blue] (1,0,2)  -- (1,0,0);
    \draw[blue] (1,0,2)  -- (0,2,2);
    \draw[blue] (1,0,2)  -- (2,2,2);
    %10
    \draw[blue] (2,0,1)  -- (2,2,2);
    % 11
